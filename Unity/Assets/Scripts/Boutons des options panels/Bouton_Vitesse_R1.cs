...
public class Bouton_Vitesse_R1 : MonoBehaviour
{
	...
	{
		ValeurInitiale = SelectedLine.V1;
	}
	
	public void AjusteWithDrag()
	{
		//string TextToRefresh;
		SelectedLine.V1 = ValeurInitiale + Interface.GetComponent<Interface>().DeltaMousePos.x/10000.0f;
		InputFieldToRefresh.GetComponent<InputField>().text = SelectedLine.V1.ToString();
	}
}
