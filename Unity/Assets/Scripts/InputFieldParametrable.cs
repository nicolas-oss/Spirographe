...
public class InputFieldParametrable : Spirographe
{
    public int index;
	...
	{
		GetActiveLine();
		ValeurInitiale = SelectedSpiroParam.RR[index];
	...
	public void AjusteWithDrag()
	{
		...
		SelectedSpiroParam.RR[index]=ValeurSortie;
	}
	...
	{
		GetActiveLine();
		Value=(float)SelectedSpiroParam.RR[index];
